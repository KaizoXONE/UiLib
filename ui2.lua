...
_G.Dark = Color3.fromRGB(20, 20, 25);
...
function Update:Window(Config)
	Config.Title = Config.Name or Config.Title or "STELLAR"
	Config.SubTitle = Config.Desc or Config.SubTitle or "v4.9"
		...
		function main:Toggle(text, config, desc, callback)
			...
			ToggleImage.MouseButton1Click:Connect(function()
				if toggled == false then
					toggled = true;
					Circle:TweenPosition(UDim2.new(0, 17, 0.5, 0), "Out", "Back", 0.4, true);
					...
					toggled = false;
					Circle:TweenPosition(UDim2.new(0, 4, 0.5, 0), "Out", "Back", 0.4, true);
					(TweenService:Create(ToggleImage, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
